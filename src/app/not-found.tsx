        ...
        <div className="h-full w-full border min-h-screen p-4 bg-white rounded-2xl">
          <div className="min-h-[60vh] flex flex-col items-center justify-center p-4">
            <div className="max-w-md w-full space-y-4 text-center font-manrope">
              ...
              <Link href="/">
                <motion.button
                  className="group relative inline-flex items-center gap-2 px-3 md:px-6 py-2 md:py-3 overflow-hidden bg-gradient-to-b from-[#C90B03] to-[#FB1910] rounded-full border border-[#C90B03] text-white font-gilroy-medium cursor-pointer"
                  whileHover="hover"
                  whileTap={{ scale: 0.98 }}
                >
