...
const dataBlock2: PortSchedule[] = [
  ...
  },
  {
    vessel: "UDDIPON EXPRESS",
    voyage: "UDP-4",
    port1: { eta: "19/04", etd: "20/04" },
    port2: { eta: "-", etd: "-" },
    port3: { eta: "-", etd: "-" },
    port4: { eta: "23/04", etd: "24/04" },
    port5: { eta: "-", etd: "-" },
    port6: { eta: "-", etd: "-" },
  },
  {
    vessel: "UDDIPON EXPRESS",
    voyage: "UDP-5",
    port1: { eta: "29/04", etd: "30/04" },
    port2: { eta: "-", etd: "-" },
    port3: { eta: "-", etd: "-" },
    port4: { eta: "04/05", etd: "05/05" },
    port5: { eta: "-", etd: "-" },
    port6: { eta: "-", etd: "-" },
  },
  {
    vessel: "UDDIPON EXPRESS",
    voyage: "UDP-6",
    port1: { eta: "09/05", etd: "10/05" },
    port2: { eta: "-", etd: "-" },
    port3: { eta: "-", etd: "-" },
    port4: { eta: "13/05", etd: "14/05" },
    port5: { eta: "-", etd: "-" },
    port6: { eta: "-", etd: "-" },
  },
];
