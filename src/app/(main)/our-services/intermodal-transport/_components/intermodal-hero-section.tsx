  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row min-h-screen lg:min-h-96">
        ...
        <motion.div
          className="w-full lg:w-2/5 bg-red-600 text-white p-8 lg:p-12 flex flex-col justify-between"
      ...
      <motion.div
        className="w-full bg-blue-700 text-white py-16 lg:py-24 px-8 lg:px-12"
        variants={containerVariants}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            className="text-lg text-blue-100 leading-relaxed text-balance"
            variants={slideUpVariants}
          >
