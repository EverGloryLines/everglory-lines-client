...
export function AgentMapSelector({
  countries,
  selectedCountry,
  onCountrySelect,
}: MapSelectorProps) {
  ...
  const maxIndex = Math.max(0, countries.length - itemsPerPage);
          ...
          */}
          {countries.map((country) => (
            <div
              ...
              className="snap-start flex-shrink-0 w-full md:w-1/2 lg:w-1/3 p-2 lg:p-4"
            >
              <motion.button
