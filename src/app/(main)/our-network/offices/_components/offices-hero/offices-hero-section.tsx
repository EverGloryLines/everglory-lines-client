  ...
  return (
    ...
    >
      ...
      >
        {/* Title */}
        <motion.h1
          className="text-white font-plus-jakarta-sans font-semibold text-5xl md:text-6xl lg:text-7xl text-center tracking-normal leading-none mb-6 md:mb-6 max-w-3xl"
          style={{
        ...
        <motion.button
          ...
          className="flex items-center gap-2 px-6 md:px-8 py-3 bg-white text-gray-900 font-semibold text-base md:text-lg rounded-none shadow-lg hover:shadow-xl transition-shadow duration-300 cusror-pointer hover:bg-white/90"
