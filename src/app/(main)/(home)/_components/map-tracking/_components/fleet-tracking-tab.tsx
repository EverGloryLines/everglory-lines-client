    ...
    <Card className="p-4 bg-background rounded-none">
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            <h3 className="text-base font-plus-jakarta-sans font-semibold">
          ...
          <Button
            ...
            className="flex-shrink-0 text-sm font-plus-jakarta-sans font-semibold cursor-pointer bg-[#4c6faf] hover:bg-[#4c6faf]/90 rounded-none"
          >
        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogContent className="max-w-2xl rounded-none">
            <DialogHeader>
              <DialogTitle className="text-base md:text-lg font-plus-jakarta-sans font-semibold">Configure Fleet Tracking</DialogTitle>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    <Label htmlFor="fleet-latitude" className="text-sm font-plus-jakarta-sans font-medium">Latitude</Label>
                    <Input
                      id="fleet-latitude"
                      type="text"
                      placeholder="36.00"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="fleet-longitude" className="text-sm font-plus-jakarta-sans font-medium">Longitude</Label>
                    <Input
                      id="fleet-longitude"
                      type="text"
                      placeholder="-5.40"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="fleet-key" className="text-sm font-plus-jakarta-sans font-medium">Fleet Key</Label>
                  <Input
                    id="fleet-key"
                    type="text"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="fleet-name" className="text-sm font-plus-jakarta-sans font-medium">Fleet Name</Label>
                  <Input
                    id="fleet-name"
                    type="text"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="fleet-timespan" className="text-sm font-plus-jakarta-sans font-medium">Timespan (minutes)</Label>
                  <Input
                    id="fleet-timespan"
                    type="text"
                    placeholder="1440"
              ...
              <DialogFooter>
                ...
                <Button type="submit"  className="text-sm font-plus-jakarta-sans font-semibold cursor-pointer bg-[#4c6faf] hover:bg-[#4c6faf]/90 rounded-none">Update Fleet Map</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
