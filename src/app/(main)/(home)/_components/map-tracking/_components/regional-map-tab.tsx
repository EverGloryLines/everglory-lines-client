        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogContent className="rounded-none">
            <DialogHeader className="mb-0">
              <DialogTitle className="text-base md:text-lg font-plus-jakarta-sans font-semibold">Configure Regional Map</DialogTitle>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4 py-1">
                <div className="grid gap-2">
                  <Label htmlFor="latitude" className="text-sm font-plus-jakarta-sans font-medium">Latitude (decimal degrees)</Label>
                  <Input
                    id="latitude"
                    type="text"
                    placeholder="36.00"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="longitude" className="text-sm font-plus-jakarta-sans font-medium">Longitude (decimal degrees)</Label>
                  <Input
                    id="longitude"
                    type="text"
                    placeholder="-5.40"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="zoom" className="text-sm font-plus-jakarta-sans font-medium">Zoom Level (3-18)</Label>
                  <Input
                    id="zoom"
                    type="text"
                    placeholder="8"
              ...
              <DialogFooter className="mt-4">
                ...
                <Button type="submit" className="text-sm font-plus-jakarta-sans font-semibold cursor-pointer bg-[#4c6faf] hover:bg-[#4c6faf]/90 rounded-none" >Update Map</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
