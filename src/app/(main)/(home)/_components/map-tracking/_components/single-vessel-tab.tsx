      ...
      <div className="space-y-4">
        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogContent className="rounded-none">
            <DialogHeader>
              <DialogTitle className="text-base md:text-lg font-plus-jakarta-sans font-semibold">Track Individual Vessel</DialogTitle>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4 py-4">
                <div className="grid gap-2">
                  <Label htmlFor="imo" className="text-sm font-plus-jakarta-sans font-medium">IMO Number</Label>
                  <Input
                    id="imo"
                    type="text"
                    placeholder="9506291"
              ...
              <DialogFooter>
                ...
                <Button type="submit"  className="text-sm font-plus-jakarta-sans font-semibold cursor-pointer bg-[#4c6faf] hover:bg-[#4c6faf]/90 rounded-none">Track Vessel</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
