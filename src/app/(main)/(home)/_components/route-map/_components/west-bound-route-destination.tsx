...
// import { MapPin, ChevronDown, ChevronLeft } from "lucide-react";
...
// export function WestBoundRouteDestination({
...
function RouteArrow({ direction }: { direction: "up" | "down" }) {
  return (
    <>
      <div className="hidden lg:flex items-center justify-center mx-3 mb-8">
        <div className="flex items-center gap-2">
          {/* Changed order: ChevronLeft first, then the horizontal line */}
          <ChevronLeft
            className="w-6 h-6 text-[#ff7336] flex-shrink-0"
            strokeWidth={3}
          />
          <div className="w-16 h-1 bg-gradient-to-r from-transparent to-[#ff7336] rounded-full"></div>
        </div>
      </div>
