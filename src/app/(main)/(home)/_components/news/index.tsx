  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "url('/homepage/news/musk-image.svg')",
              ...
              >
                <Link href={item.url} className="block">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <ArrowUpRight
                      className="flex-shrink-0 w-5 h-5 text-deep-red transition-transform duration-300 group-hover:-translate-y-1 group-hover:translate-x-1"
                      strokeWidth={2.5}
                    />
                  </div>
                </Link>
