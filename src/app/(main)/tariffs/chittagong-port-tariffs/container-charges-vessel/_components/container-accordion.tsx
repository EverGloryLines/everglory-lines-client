...
import { AccordionSection } from "@/data/tariffs/container-charges-vessel";

interface ContainerAccordionProps {
  sections: AccordionSection[];
}

export function ContainerAccordion({ sections }: ContainerAccordionProps) {
                ...
                <div className="space-y-6">
                  ...
                  {section.tables.map((table, tableIndex) => (
                    <div key={tableIndex}>
                      ...
                      <ContainerTable rows={table.rows} />
                    </div>
                  ))}
