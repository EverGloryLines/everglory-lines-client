...
export function ContainerChargesHeader() {
  ...
  return (
    ...
    >
      ...
      >
        Container Charges (Vessel Account)
      </motion.h1>
      <motion.p
        className="text-base lg:text-lg text-gray-300 max-w-sm sm:max-w-3xl mx-auto leading-relaxed tracking-tight"
        variants={itemVariants}
      >
        Wharfage, storage, and extra handling tariffs for FCL, LCL, empty, and
        reefer containers managed under the vessel account.
      </motion.p>
    </motion.div>
  );
}
