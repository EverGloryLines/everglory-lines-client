import { TariffRow } from "@/data/tariffs/dues-and-charges-cargo";

interface CargoTableProps {
  rows: TariffRow[];
}

export function CargoTable({ rows }: CargoTableProps) {
  return (
    <div className="overflow-x-auto">
      <table className="w-full font-sans font-normal text-sm border border-border">
        <thead>
          <tr className="bg-blue-900 text-white">
            <th className="px-4 py-3 text-left text-base font-medium">Description</th>
            <th className="px-4 py-3 text-center text-base font-medium">Unit</th>
